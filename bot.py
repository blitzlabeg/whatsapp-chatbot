...
VERIFY_TOKEN        = os.environ.get("VERIFY_TOKEN", "whatsapp_verify_2025")
OLLAMA_URL          = os.environ.get("OLLAMA_URL", "http://localhost:11434")
OLLAMA_MODEL        = os.environ.get("OLLAMA_MODEL", "llama3")

# ── Mock Data ─────────────────────────────────────────────────────────────────
ORDERS = {
    "ORD-1042": {"status": "Delivered ✅", "date": "28 March 2025", "total": "$34.50", "items": ["Tomatoes", "Yogurt", "Chicken Breast"]},
    "ORD-1078": {"status": "On the way 🚚", "date": "31 March 2025", "total": "$18.90", "items": ["Milk", "Cheese", "Pasta", "Rice"]},
    "ORD-1091": {"status": "Being prepared 📦", "date": "1 April 2025", "total": "$52.00", "items": ["Salmon Fillet", "Olive Oil", "Spinach"]},
}

PRODUCTS = {
    "produce":   ["Tomatoes $2.90 (20% OFF)", "Fuji Apple $3.90", "Banana $2.90 (15% OFF)", "Cucumber $1.90", "Spinach $1.50 (10% OFF)"],
    "dairy":     ["Whole Milk $2.90", "Yogurt $4.90 (25% OFF)", "White Cheese $8.90", "Butter $7.90 (10% OFF)"],
    "meat-fish": ["Chicken Breast $14.90 (15% OFF)", "Ground Beef $18.90", "Salmon Fillet $21.90 (20% OFF)"],
    "pantry":    ["Pasta $2.90", "Rice $8.90 (12% OFF)", "Olive Oil $18.90", "Flour $5.90 (8% OFF)"],
}
...
SYSTEM_PROMPT = """You are Mate, a WhatsApp shopping assistant.
We deliver groceries in 2-4 hours.
...
2. Ask if they have an ORDER NUMBER (ORD-XXXX)
...
@app.get("/")
def root():
    return {"status": "WhatsApp Chatbot is running 🤖"}
